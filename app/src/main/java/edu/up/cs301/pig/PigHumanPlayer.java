...
public class PigHumanPlayer extends GameHumanPlayer implements OnClickListener {
    ...
    public void receiveInfo(GameInfo info) {
        ...
        if (super.playerNum == 0) {
            ...
            playerScoreTextView.setText(" " + tempState.getPlayer0score());
            oppScoreTextView.setText(" " + tempState.getPlayer1score());

        } else {
            playerScoreTextView.setText(" " + tempState.getPlayer1score());
            oppScoreTextView.setText(" " + tempState.getPlayer0score());
